    ...
    return(
        ...
        <section className="about-sections">
            <div className="cat-container">
                <img src="https://suficado.com/wp-content/uploads/2022/10/sonar-con-gato-muerto-significado.webp" alt="perrito"/>
            </div>
            <div>
            ...
            <div className="presentation">
                ...
                <div className="container-img">
                    <img src='https://cdn.shopify.com/s/files/1/0533/2089/files/placeholder-images-image_large.png?format=jpg&quality=90&v=1530129081' alt='foto'/>
                </div>
            </div>
            <div>
